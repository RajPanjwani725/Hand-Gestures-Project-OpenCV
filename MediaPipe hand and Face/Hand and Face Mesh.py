...
while( cap.isOpened()):
    ...
    if ret == True:
        ...
        resultface=facemesh.process(image)
        ...
        if  resulthand.multi_hand_landmarks:
            for handlandmarks in resulthand.multi_hand_landmarks:
                mpdraw.draw_landmarks(npframe,handlandmarks,mphands.HAND_CONNECTIONS,landmark_drawing_spec=drawspect)
